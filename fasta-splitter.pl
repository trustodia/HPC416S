...
#
#  Version 0.2.5 (August 31, 2016)
#
#  Copyright (c) 2012-2015 Kirill Kryukov
#
...
my ($script_name,$script_version,$script_date,$script_years) = ('fasta-splitter','0.2.5','2016-08-31','2012-2016');
my $start_time = time;
...
if (defined($out_dir))
{
    ...
    if (!-e $out_dir) { die "Can't find output directory \"$out_dir\"\n"; }
    $out_dir .= File::Util->SL;
}
